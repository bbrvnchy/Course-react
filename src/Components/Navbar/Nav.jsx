    ...
    <nav className={classes.navbar}>
        <ul className='menu'>
            <li className={classes.list}>
                ...
                <a href="/profile" className={classes.link}>My profile</a>
            </li>
            <li className={classes.list}>
            ...
            <ion-icon name="chatbubble-outline" className={classes.icon}></ion-icon>
                <a href="/message" className={classes.link}>Message</a>
            </li>
            <li className={classes.list}>
                <ion-icon name="person-outline" className={classes.icon}></ion-icon>
                <a href="/friends" className={classes.link}>Friends</a>
            </li>
            <li className={classes.list}>
                <ion-icon name="people-outline" className={classes.icon}></ion-icon>
                <a href="/communities" className={classes.link}>Communities</a>
            </li>
            <li className={classes.list}>
