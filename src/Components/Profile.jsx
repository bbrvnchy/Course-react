    ...
    <main className={classes.content}>
        <section className='myList'>
            ...
            <div className='myList__landing landing'>
                ...
                <div className='landing__HB'>Date of Birth: 22 june</div>
                <div className='landing__City'>City: Minsk</div>
                <div className='landing__Education'>Education: GGPK</div>
                <div className='landing__WebSite'>Web Site:...@mail.ru</div>
            </div>
        </section>
    </main>
    )
